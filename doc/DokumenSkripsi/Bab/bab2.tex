...
\begin{enumerate}
	...
	\item \textbf{Seleksi} \\
	Proses seleksi akan terjadi berdasarkan nilai \textit{fitness} $\textrm{f}(i)$ setiap individu. Individu yang lebih "kuat" akan memiliki peluang terpilih lebih besar dalam proses seleksi.
